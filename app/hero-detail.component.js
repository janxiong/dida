...
var HeroDetailComponent = (function () {
    ...
    HeroDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            var date = params['id'];
            _this.heroService.getHero(date)
    ...
    HeroDetailComponent.prototype.updateContact = function (SelectedContact) {
        this.hero.name = SelectedContact.name;
        this.hero.oncall = SelectedContact.cellphone;
        this.hero.oncall_id = SelectedContact.id;
    };
    HeroDetailComponent.prototype.updateContactshift = function (SelectedContact) {
